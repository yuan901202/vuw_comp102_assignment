...
public class Oval implements Shape{
  ...
  public boolean on(double u, double v){
    ...
    // YOUR CODE HERE
    double dx = u - (this.x + this.wd/2);
    double dy = y - (this.y + this.ht/2);
    return(4*dx*dx/this.sqwd + 4*dy*dy/this.sqht <= 1); // here to allow the template file to compile - please change
  }
